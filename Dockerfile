...
RUN CGO_ENABLED=0 GOOS=${TARGETOS:-linux} GOARCH=${TARGETARCH} go build -a -o bin/extension-traefik ./cmd/extension-traefik
...
ENTRYPOINT ["/usr/local/bin/extension-traefik"]
